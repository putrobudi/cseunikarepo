...
@section('content')
	<h1 align="center">HMPTI</h1>
	<p align="center">
	  Selamat datang di laman kegiatan HMPTI.
	</p>
	<div class="row">
		<div class="col-md-12 col-md-offset-0">
			...
			@if($peran_id != 2)
				...
				@else
					<div class="panel-heading"><strong>Kegiatan HMPTI</strong></div>
				@endif
						...
						<div class="tab-content">
							...
							<div id="rencana_kegiatan" class="tab-pane fade in active">
								...
								@else
												@if(count($kegiatans))
													...
													@if($i == 0)
														<h3>Untuk saat ini HMPTI tidak memiliki rencana kegiatan.</h3>
													@endif
												@else
													<h3>Tidak ada kegiatan ditemukan</h3>	
												@endif	
							...
							<div id="arsip_kegiatan" class="tab-pane fade"> {{-- Tab konten arsip kegiatan --}}
									@if(count($kegiatans))
														...
														@if($i == 0)
															<h3>Tidak ada arsip kegiatan HMPTI ditemukan.</h3>
														@endif
													@else
														<h3>Tidak ada kegiatan ditemukan</h3>	
													@endif	
